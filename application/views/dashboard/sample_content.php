<!-- Page Content -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12"> <img class="img-responsive" alt="user" src="../plugins/images/big/img2.jpg">
                        <div class="white-box">
                    ...
                    <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12"> <img class="img-responsive" alt="user" src="../plugins/images/big/img3.jpg">
                        <div class="white-box">
                            <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
                    ...
                    <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12"> <img class="img-responsive" alt="user" src="../plugins/images/big/img4.jpg">
                        <div class="white-box">
                            <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            <ul id="themecolors" class="m-t-20">
                                ...
                                <li><a href="#" data-theme="gray" class="yellow-theme">3</a></li>
                                <li><a href="#" data-theme="blue" class="blue-theme">4</a></li>
