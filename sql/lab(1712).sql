...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2019 at 11:58 PM
...
(10, '161402028', 'Febria Sahrina', '2019/2020', '1'),
(11, '161402007', 'Ilham Kurnia Wahyudi Rusli', '2019/2020', '1'),
(12, '161402130', 'Yunita S Marito Pane', '2019/2020', '1');
...
(21, 'KB A1', 'rktdnv', '2019/2020', 11, 3, 'IK3'),
(22, 'KB A2', 'whqamt', '2019/2020', 11, 9, 'IK4'),
(23, 'KDJK A1', 'v2q8bd', '2019/2020', 12, 19, 'TI4'),
(24, 'KDJK A2', 'uuppcm', '2019/2020', 12, 20, 'TI4'),
(25, 'IMK A1', '76kagk', '2019/2020', 3, 0, '-'),
(26, 'IMK A2', 'qqbewu', '2019/2020', 3, 0, '-');
...
('161402007', 'Ilham Kurnia Wahyudi Rusli', 1, 'ilham@gmail.com', 'ilham123'),
('161402028', 'Febria Sahrina', 1, 'febri@gmail.com', 'febri123'),
('161402100', 'Sinta', 1, 'sinta@gmail.com', 'sinta123'),
('161402130', 'Yunita S Marito Pane', 1, 'yunita@gmail.com', 'yunita123'),
...
('181402064', 'Xixillia Sun', 2, 'xixil@gmail.com', 'xxl123'),
...
--
ALTER TABLE `aslab`
  MODIFY `id_aslab` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `kelas`
  ADD CONSTRAINT `id_aslab` FOREIGN KEY (`id_aslab`) REFERENCES `aslab` (`id_aslab`) ON DELETE CASCADE ON UPDATE CASCADE;
