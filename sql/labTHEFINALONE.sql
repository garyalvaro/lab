...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2020 at 09:29 PM
...
(38, '181402052', 'pw', 'ddp', 3.5, 4, 'luiis', '181402052_12.pdf', '181402052_13.pdf', 'In spirit dry together fruit together had isn\'t great living subdue herb, bearing it female. Two earth moved, rule cattle second night beginning midst all likeness living form fowl blessed unto grass behold give they\'re it. Isn\'t itself divide beast moveth sea he male.', 0);
...
('181402064', 'Xixillia Sun', 0, 'xixil@gmail.com', 'xxl123', '', 1),
...
--
ALTER TABLE `nilai`
  MODIFY `id_nilai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=325;
